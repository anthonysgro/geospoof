...
export const de: Dictionary = {
  ...
  products: {
    eyebrow: "Produkte",
    heading: "Zwei Produkte, eine Standort-Story",
    subhead:
      "Fang kostenlos im Browser an. Geh auf deinem iPhone eine Ebene tiefer, wenn auch dein echtes GPS mitziehen soll.",
    free: {
      badge: "Kostenlos",
    ...
    pro: {
      ...
      title: "GeoSpoof GPS",
      description:
        "Setze das echte, systemweite GPS deines iPhones auf deinen gefälschten Standort — gesteuert von einer Mac-Begleit-App.",
      cta: "GeoSpoof GPS entdecken",
  ...
  activate: {
    ...
    success: {
      ...
      body: "Websites in Safari erhalten jetzt deinen GeoSpoof-Standort. Das GPS deines iPhones und deine IP-Adresse sind davon unabhängig und wurden nicht geändert.",
      ...
      fullVerificationNote:
        "Die vollständige Überprüfung vergleicht außerdem deinen Browser-Standort mit deinem IP-Standort.",
    },
    wrongBrowser: {
  ...
  gps: {
    ...
    hero: {
      ...
      intro:
        "GeoSpoof GPS ist ein macOS-Menüleisten-Begleiter, der den systemweiten Standort eines verbundenen iPhones auf den Ort setzt, den du in GeoSpoof wählst. So erzählen dein Browser und das echte GPS deines Telefons dieselbe Geschichte.",
    },
    download: {
