...
export const de: Dictionary = {
  ...
  hero: {
    ...
    gpsBadge: "Neu",
    gpsHint: "Ändere den echten GPS-Standort deines iPhones",
  ...
  products: {
    eyebrow: "Zwei Apps",
    heading: "GeoSpoof und GeoSpoof GPS",
    subhead:
      "GeoSpoof ist die App, die du installierst, um zu steuern, was Websites sehen. GeoSpoof GPS ist der kostenlose Desktop-Begleiter, der das Ganze aus dem Browser holt und auf das echte GPS deines iPhones bringt.",
    availableOn: "Verfügbar für",
    requires: "Benötigt",
    app: {
      badge: "Kostenlos",
      title: "GeoSpoof",
      tagline: "Browser-Erweiterung und Mobil-App",
      description:
        "Fälsche Geolocation, Zeitzone und WebRTC, sodass Websites den Ort sehen, den du wählst, statt deines echten. Kein Konto, kein Tracking.",
      platforms: "Chrome, Firefox, Edge, Brave, Safari, iPhone, iPad, Mac",
    },
    gps: {
      badge: "Kostenlose Begleit-App",
      title: "GeoSpoof GPS",
      tagline: "Menüleisten-App für Mac und Windows",
      description:
        "Geht über den Browser hinaus und setzt das echte, systemweite GPS deines iPhones auf den Ort, den du in GeoSpoof wählst. Sie sitzt in der Menüleiste — kein Fenster zu verwalten.",
      platforms: "macOS, Windows",
      requirement:
        "GeoSpoof Pro auf deinem iPhone, und dein iPhone muss mit dem Computer verbunden sein, wenn du einen Ort setzt",
      cta: "GeoSpoof GPS holen",
    },
    pro: {
      badge: "Pro",
      title: "GeoSpoof Pro",
      description:
        "Pro ist ein Upgrade innerhalb der iPhone-App, kein dritter Download. Es schaltet das geräteweite GPS frei, das GeoSpoof GPS steuert — dazu automatische VPN-Synchronisierung, Widgets, Kartenauswahl und Filter pro Website.",
      cta: "Pro ansehen",
  ...
  pro: {
    meta: {
      title: "GeoSpoof Pro — Gratis vs. Pro, Preise & Funktionen | GeoSpoof",
      description:
        "Gratis-GeoSpoof im Vergleich mit GeoSpoof Pro. Pro schaltet das echte System-GPS deines iPhones frei, dazu GPX-Routen, automatische VPN-Neusynchronisierung, Regeln pro Website, Widgets und mehr. $1.99/Monat, $9.99/Jahr oder $24.99 einmalig — abgerechnet über den App Store.",
      ogTitle: "GeoSpoof Pro — Gratis vs. Pro, Preise & Funktionen",
    },
    hero: {
      breadcrumbHome: "Start",
      breadcrumb: "Pro",
      badge: "GeoSpoof Pro",
      heading: "Alles, was GeoSpoof kann — freigeschaltet",
      subhead:
        "Standort, Zeitzone und WebRTC zu fälschen ist gratis. Pro ergänzt die Profi-Werkzeuge auf iPhone und iPad — angefangen beim echten, systemweiten GPS deines Geräts.",
      ctaPrimary: "GeoSpoof Pro holen",
      ctaSecondary: "Gratis und Pro vergleichen",
      trust: "Kein Konto · Kein Tracking · Open Source",
    },
    plans: {
      eyebrow: "Gratis vs. Pro",
      heading: "Was du in jedem Fall bekommst",
      subhead:
        "Der Kern des Spoofings ist gratis: jede Website, eine passende Zeitzone und keine WebRTC-Lecks. Bei Pro geht es um Komfort und Kontrolle — nie darum, deine Privatsphäre zurückzuhalten.",
      featureHeader: "Funktion",
      freeHeader: "Gratis",
      proHeader: "Pro",
      bothValue: "Gratis und Pro",
      proOnlyValue: "Nur Pro",
      rows: {
        spoofing: "Standort-Spoofing auf allen Websites",
        timezoneWebrtc: "Passende Zeitzone und WebRTC-Schutz",
        vpnSync: "VPN-Sync, Städtesuche, exakte Koordinaten",
        ...
        autoResync: "Automatische VPN-Neusynchronisierung",
        perSite: "Regeln pro Website, Genauigkeit und Sprache",
        widgets: "Widgets und Bedienelemente",
      },
      legend: {
        both: "In beiden Tarifen",
        proOnly: "Nur Pro",
      },
      scopeNote:
        "Dieser Vergleich betrifft die App für iPhone und iPad. Die Erweiterungen für Chrome, Firefox, Edge und Brave sind gratis, ebenso GeoSpoof GPS für Mac und Windows.",
    },
    unlocks: {
      eyebrow: "Was Pro freischaltet",
      heading: "Die Erweiterungen im Detail",
      subhead:
        "All das gibt es, weil der gratis Weg schon funktioniert. Das sind die Gründe, aus denen Leute upgraden.",
      items: {
        gps: {
          title: "Geräte-GPS",
          body: "Setze den echten, systemweiten Standort, den dein iPhone meldet — an Karten, an Wetter, an jede App, die fragt. Benötigt die gratis App GeoSpoof GPS auf einem Mac oder Windows-PC.",
        },
        routes: {
          title: "GPX-Routen",
          body: "Importiere eine Route und folge ihr in realistischem Tempo, mit einer Live-Position, die sich entlang des Wegs bewegt. Pausieren, fortsetzen, neu starten oder in Schleife.",
        },
        offlineHold: {
          title: "Lass den Computer zurück",
          body: "Schalte den Entwicklermodus aus, während ein Standort gesetzt ist, und dein iPhone behält ihn, nachdem die Verbindung zum Computer endet. Solange er hält, bleibt der Standort fest.",
        },
        autoResync: {
          title: "Automatische VPN-Neusynchronisierung",
          body: "Dein Standort folgt im Hintergrund der Exit-Region deines VPN — bei jedem Wechsel des Exit-Servers, ohne dass du etwas tun musst.",
        },
        perSite: {
          title: "Regeln pro Website und Feinabstimmung",
          body: "Zulassen- und Sperrlisten, damit nur die von dir gewählten Websites gefälscht werden, dazu Genauigkeit, ungefährer Standort und Sprache.",
        },
        mapPicker: {
          title: "Kartenauswahl",
          body: "Setze eine Markierung an eine beliebige Stelle der Karte und nutze sie als Standort, statt Koordinaten zu tippen.",
        },
        widgets: {
          title: "Widgets und Bedienelemente",
          body: "Wechsle den Standort vom Home-Bildschirm, Sperrbildschirm oder Kontrollzentrum, ohne die App zu öffnen.",
        },
        future: {
          title: "Und mehr wird folgen",
          body: "Neue Pro-Funktionen sind im selben Kauf enthalten, sobald sie erscheinen.",
        },
      },
    },
    pricing: {
      eyebrow: "Preise",
      heading: "Ein Kauf, alle Apple-Geräte",
      subhead:
        "Wähle den Tarif in der App. Pro schaltet iPhone, iPad und Mac mit demselben Apple-Account frei — kein Konto anlegen, nichts einloggen.",
      cta: "GeoSpoof Pro holen",
      universal: "Ein Kauf schaltet iPhone, iPad und Mac frei.",
      fineprint:
        "Abrechnung über den App Store. Preise in USD; Apple berechnet deinen lokalen Preis inklusive Steuern. Jederzeit kündbar.",
      lifetimeNote:
        "Lebenslang ist ein Einmalkauf. Es ist kein Abo und verlängert sich nicht.",
      monthly: {
        name: "Monatlich",
        price: "$1.99",
        period: "/Mon.",
      ...
      yearly: {
        ...
        price: "$9.99",
        period: "/Jahr",
        subNote: "etwa $0.83/Mon.",
        note: "58 % günstiger als monatlich",
    ...
    requirements: {
      heading: "Vor dem Kauf",
      computer:
        "Geräte-GPS benötigt einen Mac oder Windows-PC — einmal per Kabel koppeln, danach läuft es über Wi-Fi. Alle anderen Pro-Funktionen laufen allein auf dem Telefon.",
      arGames:
        "Nicht für AR-Spiele wie Pokémon GO — das Geräte-GPS dient Privatsphäre, Surfen und Entwicklung.",
      extensions:
        "Die Browser-Erweiterungen für Chrome, Firefox, Edge und Brave sind gratis und nicht Teil von Pro.",
    },
    faq: {
      heading: "Fragen zu Pro",
      items: [
        {
          q: "Ist GeoSpoof gratis?",
          a: "Ja. Die Browser-Erweiterung ist in jedem großen Browser gratis, und die App für iPhone und iPad fälscht Standort, Zeitzone und WebRTC kostenlos — inklusive VPN-Sync mit einem Klick, Städtesuche und exakten Koordinaten. Pro ergänzt Geräte-GPS und die erweiterten Einstellungen.",
        },
        {
          q: "Brauche ich einen Mac oder PC für Pro?",
          a: "Nur für Geräte-GPS. GeoSpoof GPS ist eine gratis Begleit-App für Mac und Windows: einmal per Kabel koppeln, danach läuft es über Wi-Fi. Jede andere Pro-Funktion läuft allein auf dem Telefon.",
        },
        {
          q: "Für wie viele Geräte gilt ein Kauf?",
          a: "Es ist ein Universal-Kauf: iPhone, iPad und Mac sind mit demselben Apple-Account abgedeckt. Die Berechtigung reist mit deinem Apple-Account — kein Login, kein Wiederherstellen auf dem zweiten Gerät.",
        },
        {
          q: "Kann ich einmalig zahlen statt zu abonnieren?",
          a: "Ja. Die lebenslange Freischaltung für $24.99 ist ein Einmalkauf. Sie ist kein Abo und verlängert sich nie.",
        },
        {
          q: "Funktioniert Geräte-GPS für Pokémon GO?",
          a: "Nein. Geräte-GPS ist für Privatsphäre, Surfen und Entwicklung gemacht, und wir unterstützen keine AR-Spiele.",
        },
        {
          q: "Wie kündige ich?",
          a: "In der App „Einstellungen“ unter deinem Apple-Account, dann „Abos“. Pro läuft bis zum Ende des bereits bezahlten Zeitraums weiter.",
        },
      ],
      gpsLead: "Erst die Details zum Geräte-GPS? ",
      gpsLink: "Mehr über GeoSpoof GPS",
      gpsTail: " — die gratis Desktop-App, die es steuert.",
    },
  },
  footer: {
    groups: {
    ...
    links: {
      geospoofIos: "GeoSpoof für iPhone & iPad",
    ...
    copyright: "© {year} GeoSpoof LLC. Alle Rechte vorbehalten.",
  },
  languageSwitcher: {
    label: "Sprache",
  ...
  activate: {
    meta: {
      title: "GeoSpoof in Safari aktivieren",
      description:
        "Aktiviere die GeoSpoof-Erweiterung in Safari und bestätige den von Safari gemeldeten Standort.",
    },
    preparing: "Safari-Einrichtung wird vorbereitet",
    waiting: {
      eyebrow: "Safari-Einrichtung",
      heading: "Safari-Einrichtung abschließen",
      body: "Aktiviere GeoSpoof in Safari. Danach geht es automatisch weiter.",
      status: "GeoSpoof wird auf dieser Seite gesucht …",
      notActive: "GeoSpoof ist auf dieser Seite noch nicht aktiv.",
      onLabel: "Ein",
      inSafari: "In Safari",
      pageSettings: {
        title: "Seiteneinstellungen öffnen",
        body: "Tippe neben der Safari-Adressleiste auf die Taste für die Seiteneinstellungen.",
      },
      steps: [
        {
          title: "Seitenmenü öffnen",
          body: "Tippe neben der Safari-Adressleiste auf die Taste für das Seitenmenü.",
        },
        {
          title: "„Erweiterungen verwalten“ auswählen",
          body: "Suche GeoSpoof in der Liste und schalte es ein.",
        },
        {
          title: "Website-Zugriff erlauben",
          body: "Erlaube GeoSpoof den Zugriff auf diese Website. Safari fordert dich möglicherweise zum Neuladen auf.",
        },
      ],
      permissionsBanner:
    ...
    troubleshooting: {
      summary: "GeoSpoof wird nicht angezeigt?",
      items: [
        "Prüfe, ob GeoSpoof aufgeführt und eingeschaltet ist.",
        "Wenn du Safari-Profile verwendest, stelle sicher, dass GeoSpoof für das aktuelle Profil aktiviert ist.",
    ...
    checking: {
      eyebrow: "Safari-Einrichtung",
      heading: "Dein Standort wird bestätigt",
      status: "Safari-Meldung wird gelesen …",
      unavailable: "Nicht verfügbar",
    },
    error: {
      eyebrow: "GeoSpoof ist aktiv",
      heading: "Safari hat noch keinen Standort zurückgegeben",
      body: "Stelle sicher, dass die Standortsimulation in GeoSpoof aktiviert ist, und versuche es erneut.",
      retry: "Standort erneut prüfen",
      support: "Hilfe erhalten",
    },
    success: {
      status: "Safari ist bereit",
      heading: "GeoSpoof funktioniert in Safari",
      locationLabel: "Von Safari gemeldeter Standort",
      timezoneLabel: "Gemeldete Zeitzone",
      returnToApp: "Zu GeoSpoof zurückkehren",
      fullVerification: "Vollständige Überprüfung starten",
    },
    desktop: {
      heading: "GeoSpoof über die Mac-App einrichten",
      body: "Diese Seite beschreibt die Einrichtung auf dem iPhone. Öffne auf dem Mac GeoSpoof und nutze „In Safari aktivieren“ — damit landest du direkt in den Erweiterungseinstellungen von Safari.",
    },
    wrongBrowser: {
      eyebrow: "Safari erforderlich",
      heading: "Diese Seite in Safari öffnen",
      body: "Die iPhone-Erweiterung von GeoSpoof läuft in Safari. Deshalb muss dieser Einrichtungsschritt dort abgeschlossen werden.",
      copyInstruction: "Kopiere diese Adresse und füge sie in Safari ein:",
      copied: "Adresse kopiert",
      copy: "Aktivierungsadresse kopieren",
      copyError:
        "Kopieren ist in diesem Browser nicht verfügbar. Halte die Adresse oben gedrückt, um sie zu kopieren.",
      iosTip:
        "Tipp: Du kannst den Link auch über das Teilen-Menü dieses Browsers kopieren und in Safari einfügen.",
    },
  },
  verify: {
    meta: {
  ...
  gps: {
    ...
    experimental: {
      ...
      body: "GeoSpoof GPS ist neu und wird noch geräteübergreifend erprobt, also rechne mit ein paar Ecken und Kanten und etwas einmaliger Einrichtung. Es ist eine optionale Ergänzung. Der Rest von GeoSpoof funktioniert auch ohne sie einwandfrei.",
    },
    hero: {
    ...
    setup: {
      ...
      intro:
        "Öffne das Menüleisten-Symbol und wähle „Einrichten…“. Der Assistent hakt jeden Schritt ab, während du vorgehst. Verbinde dein iPhone per Kabel, um die Einrichtung abzuschließen. Danach kann dein Mac das GPS über WLAN oder einen Hotspot steuern, solange die beiden einander erreichen.",
      steps: [
        {
          name: "App installieren",
          text: "Öffne das DMG, zieh GeoSpoof GPS in den Ordner „Programme“ und starte es dann. Es läuft in der Menüleiste (kein Dock-Symbol, kein Fenster) und öffnet beim ersten Start den Einrichtungsassistenten.",
        },
        {
          name: "Zugriff aufs lokale Netzwerk erlauben",
          text: "Beim ersten Start fragt macOS nach Zugriff aufs lokale Netzwerk. Klicke auf „Erlauben“, damit GeoSpoof GPS dein iPhone finden und mit ihm kommunizieren kann. Ohne diese Berechtigung sieht die App dein Telefon nicht.",
          bullets: [
            "Abfrage verpasst? Aktiviere ihn unter Systemeinstellungen ▸ Datenschutz & Sicherheit ▸ Lokales Netzwerk ▸ GeoSpoof GPS.",
            "Ein hängendes „Kein Gerät gefunden“ ist meist ein Zeichen dafür, dass diese Berechtigung fehlt.",
          ],
        },
        {
          name: "Xcode installieren",
          text: "GeoSpoof GPS benötigt Apples Developer Disk Image, und es steckt in Xcode. Starte diesen Download zuerst – er ist groß (mehrere GB), lass ihn also im Hintergrund laufen, während du die schnellen iPhone-Schritte unten erledigst.",
          bullets: [
            "Installiere Xcode (kostenlos) aus dem Mac App Store und starte es einmal.",
            "Beim ersten Start erscheint ein Bildschirm „Plattformen auswählen“. Aktiviere macOS und lass die übrigen (auch iOS) deaktiviert, dann fahre fort – du brauchst weder das iOS-SDK noch den Simulator; das Entwickler-Image gehört ohnehin zur Grundausstattung von Xcode.",
            "Lass „Komponenten werden installiert“ abschließen und beende dann Xcode. Kein Projekt, kein Build, nichts zu kompilieren und kein kostenpflichtiges Apple-Developer-Konto.",
            "Schon ein Entwickler-Image vorhanden? Verweise GeoSpoof GPS auf diesen Ordner und spar dir den Xcode-Download komplett.",
          ],
          link: { label: "Xcode im Mac App Store holen" },
        },
        {
          name: "iPhone verbinden",
          text: "Verbinde dein iPhone mit deinem Mac und entsperre es. Verwende ein datenfähiges Kabel, denn manche laden nur. Erscheint es nicht, probiere ein anderes Kabel oder einen anderen Anschluss.",
        },
        {
          name: "Diesem Computer vertrauen",
          text: "Wenn dein iPhone fragt, ob du diesem Computer vertrauen willst, tippe auf „Vertrauen“ und gib deinen Code ein. So können Mac und Telefon miteinander kommunizieren.",
          bullets: [
            "Keine Abfrage? Halte das Telefon entsperrt, dann zieh das Kabel ab und steck es wieder ein. Der Hinweis erscheint nur bei entsperrtem Bildschirm.",
            "Immer noch nichts? Sperre und entsperre das Telefon (oder starte es neu) und verbinde erneut.",
            "Nur als letzter Ausweg: Einstellungen ▸ Allgemein ▸ iPhone übertragen oder zurücksetzen ▸ Zurücksetzen ▸ Standort & Datenschutz zurücksetzen, dann erneut verbinden und auf „Vertrauen“ tippen.",
          ],
        },
        {
          name: "Entwicklermodus aktivieren",
          text: "Öffne auf dem iPhone Einstellungen ▸ Datenschutz & Sicherheit ▸ Entwicklermodus, schalte ihn ein und starte auf Nachfrage neu. Er erscheint erst, nachdem das Telefon mindestens einmal mit deinem Mac verbunden war.",
        },
        {
          name: "Mit diesem Mac koppeln",
          text: "Klicke im Einrichtungsfenster auf „Koppeln“. Dieser einmalige, sichere Handshake erlaubt deinem Mac, das GPS des iPhones zu steuern. Halte das Telefon währenddessen entsperrt und verbunden.",
        },
        {
          name: "Entwickler-Image vorbereiten",
          text: "Setzt ein installiertes Xcode voraus (oben). Klicke bei verbundenem und entsperrtem iPhone auf „Vorbereiten“. GeoSpoof GPS personalisiert Apples Developer Disk Image (DDI) für dein Gerät und hängt es ein – der Baustein, mit dem eine App deinen echten GPS-Standort setzen kann. Es ist von Apple signiert und wird für dich erledigt; es gibt nichts einzustellen.",
          powerUserNote:
            "Image nicht gefunden? Wenn „Vorbereiten“ meldet, dass das Entwickler-Image fehlt, ist Xcodes Einrichtung womöglich noch nicht fertig. Öffne das Terminal, führe dies aus und klicke dann erneut auf „Vorbereiten“:",
        },
        {
    ...
    connection: {
      ...
      links: [
        {
          title: "USB-Kabel",
          body: "Die zuverlässigste Variante und die, über die die Ersteinrichtung läuft. Verwende ein datenfähiges Kabel und halte das Telefon entsperrt.",
        },
        {
          title: "Dasselbe WLAN",
    ...
    help: {
      ...
      body: "Wenn ein Schritt nicht klappt, findest du auf unserer Support-Seite weitere Lösungen. Einen Fehler entdeckt oder eine Idee? Wir hören gern von dir.",
