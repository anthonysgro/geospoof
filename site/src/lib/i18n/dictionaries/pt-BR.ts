...
export const ptBR: Dictionary = {
  ...
  hero: {
    ...
    subhead:
      "Um VPN muda o seu IP, mas os seus dispositivos continuam revelando a sua localização real. O GeoSpoof termina o serviço — do navegador ao GPS real do seu iPhone.",
  ...
  pro: {
    meta: {
      title: "GeoSpoof Pro — Grátis vs Pro, preços e recursos | GeoSpoof",
      description:
        "Compare o GeoSpoof grátis com o GeoSpoof Pro. O Pro libera o GPS real do sistema do seu iPhone, rotas GPX, ressincronização automática de VPN, regras por site, widgets e mais. $1.99/mês, $9.99/ano ou $24.99 uma vez — cobrado pela App Store.",
      ogTitle: "GeoSpoof Pro — Grátis vs Pro, preços e recursos",
    },
    hero: {
      breadcrumbHome: "Início",
      breadcrumb: "Pro",
      badge: "GeoSpoof Pro",
      heading: "Tudo o que o GeoSpoof faz, desbloqueado",
      subhead:
        "Falsificar sua localização, seu fuso horário e o WebRTC é grátis. O Pro acrescenta as ferramentas avançadas no iPhone e no iPad — começando pelo GPS real, de nível de sistema, do seu aparelho.",
      ctaPrimary: "Obter o GeoSpoof Pro",
      ctaSecondary: "Comparar Grátis e Pro",
      trust: "Sem conta · Sem rastreamento · Código aberto",
    },
    plans: {
      eyebrow: "Grátis vs Pro",
      heading: "O que você leva, de qualquer forma",
      subhead:
        "O núcleo da falsificação é grátis: todos os sites, um fuso horário correspondente e nenhum vazamento de WebRTC. O Pro é sobre poder e conveniência, nunca sobre segurar a sua privacidade.",
      featureHeader: "Recurso",
      freeHeader: "Grátis",
      proHeader: "Pro",
      bothValue: "Grátis e Pro",
      proOnlyValue: "Só no Pro",
      rows: {
        spoofing: "Localização falsa em todos os sites",
        timezoneWebrtc: "Fuso horário correspondente e proteção WebRTC",
        vpnSync: "Sincronização VPN, busca de cidades, coordenadas exatas",
        ...
        autoResync: "Ressincronização automática de VPN",
        perSite: "Regras por site, precisão e idioma",
        widgets: "Widgets e controles",
      },
      legend: {
        both: "Nos dois planos",
        proOnly: "Só no Pro",
      },
      scopeNote:
        "Esta comparação é do app para iPhone e iPad. As extensões para Chrome, Firefox, Edge e Brave são grátis, e o GeoSpoof GPS para Mac e Windows também.",
    },
    unlocks: {
      eyebrow: "O que o Pro libera",
      heading: "Os acréscimos, em detalhe",
      subhead:
        "Cada um deles existe porque o caminho grátis já funciona. São estes os motivos pelos quais as pessoas assinam.",
      items: {
        gps: {
          title: "GPS do aparelho",
          body: "Defina a localização real, de nível de sistema, que o seu iPhone informa — ao Mapas, ao Tempo, a qualquer app que perguntar. Precisa do app grátis GeoSpoof GPS num Mac ou PC com Windows.",
        },
        routes: {
          title: "Rotas GPX",
          body: "Importe uma rota e percorra em ritmo realista, com uma posição ao vivo que avança pelo trajeto. Pause, retome, comece de novo ou repita em loop.",
        },
        offlineHold: {
          title: "Deixe o computador para trás",
          body: "Desligue o Modo de Desenvolvedor com uma localização definida e o seu iPhone a mantém depois que o vínculo com o computador termina. Enquanto durar, a localização fica fixa.",
        },
        autoResync: {
          title: "Ressincronização automática de VPN",
          body: "Sua localização segue a região de saída do seu VPN em segundo plano, a cada troca de nó de saída, sem você mexer em nada.",
        },
        perSite: {
          title: "Regras por site e ajuste fino",
          body: "Listas de permitir e bloquear para falsificar só os sites que você escolher, além de precisão, localização aproximada e idioma.",
        },
        mapPicker: {
          title: "Seletor no mapa",
          body: "Solte um alfinete em qualquer ponto do mapa e use como sua localização, em vez de digitar coordenadas.",
        },
        widgets: {
          title: "Widgets e controles",
          body: "Troque de localização pela Tela de Início, pela Tela Bloqueada ou pela Central de Controle, sem abrir o app.",
        },
        future: {
          title: "E vem mais por aí",
          body: "Os novos recursos Pro entram na mesma compra, à medida que são lançados.",
        },
      },
    },
    pricing: {
      eyebrow: "Preços",
      heading: "Uma compra, todos os seus aparelhos Apple",
      subhead:
        "Escolha o plano dentro do app. O Pro libera iPhone, iPad e Mac na mesma Conta Apple — não há conta para criar nem login para fazer.",
      cta: "Obter o GeoSpoof Pro",
      universal: "Uma compra libera iPhone, iPad e Mac.",
      fineprint:
        "Cobrado pela App Store. Preços em USD; a Apple cobra o seu preço local, com impostos. Cancele quando quiser.",
      lifetimeNote:
        "O vitalício é uma compra única. Não é assinatura e não se renova.",
      monthly: {
        name: "Mensal",
        price: "$1.99",
        period: "/mês",
      ...
      yearly: {
        ...
        price: "$9.99",
        period: "/ano",
        subNote: "cerca de $0.83/mês",
        note: "Economize 58% vs mensal",
        badge: "Mais popular",
      },
      lifetime: {
        name: "Vitalício",
    ...
    requirements: {
      ...
      computer:
        "O GPS do aparelho precisa de um Mac ou PC com Windows — pareia uma vez com cabo e depois funciona por Wi-Fi. Todos os outros recursos Pro rodam só no telefone.",
      arGames:
        "Não serve para jogos de RA como Pokémon GO — o GPS do dispositivo é para privacidade, navegação e desenvolvimento.",
      extensions:
        "As extensões de navegador para Chrome, Firefox, Edge e Brave são grátis e não fazem parte do Pro.",
    },
    faq: {
      heading: "Perguntas sobre o Pro",
      items: [
        {
          q: "O GeoSpoof é grátis?",
          a: "Sim. A extensão de navegador é grátis em todos os principais navegadores, e o app para iPhone e iPad falsifica localização, fuso horário e WebRTC de graça — incluindo sincronização VPN com um toque, busca de cidades e coordenadas exatas. O Pro acrescenta o GPS do aparelho e os controles avançados.",
        },
        {
          q: "Preciso de um Mac ou PC para usar o Pro?",
          a: "Só para o GPS do aparelho. O GeoSpoof GPS é um app companheiro grátis para Mac e Windows: você pareia uma vez com cabo e depois ele funciona por Wi-Fi. Todo o resto do Pro roda no telefone sozinho.",
        },
        {
          q: "Uma compra cobre quantos aparelhos?",
          a: "É uma Compra Universal: iPhone, iPad e Mac ficam cobertos na mesma Conta Apple. O direito viaja com a sua Conta Apple — sem login e sem restaurar compras no segundo aparelho.",
        },
        {
          q: "Posso pagar uma vez em vez de assinar?",
          a: "Pode. O desbloqueio vitalício de $24.99 é uma compra única. Não é assinatura e nunca se renova.",
        },
        {
          q: "O GPS do aparelho funciona para Pokémon GO?",
          a: "Não. O GPS do aparelho é feito para privacidade, navegação e desenvolvimento, e não damos suporte a jogos de RA.",
        },
        {
          q: "Como eu cancelo?",
          a: "No app Ajustes, na sua Conta Apple e depois em Assinaturas. O Pro continua funcionando até o fim do período que você já pagou.",
        },
      ],
      gpsLead: "Quer primeiro os detalhes do GPS do aparelho? ",
      gpsLink: "Leia sobre o GeoSpoof GPS",
      gpsTail: " — o app de desktop grátis que faz isso acontecer.",
    },
  },
  footer: {
    groups: {
  ...
  activate: {
    meta: {
      title: "Ativar o GeoSpoof no Safari",
      description:
        "Ative a extensão do GeoSpoof no Safari e confirme a localização informada pelo Safari.",
    },
    preparing: "Preparando a configuração do Safari",
    waiting: {
      eyebrow: "Configuração do Safari",
      heading: "Conclua a configuração do Safari",
      body: "Ative o GeoSpoof no Safari. Continuaremos automaticamente.",
      status: "Aguardando o GeoSpoof nesta página…",
      notActive: "O GeoSpoof ainda não está ativo nesta página.",
      onLabel: "Ativado",
      inSafari: "No Safari",
      pageSettings: {
        title: "Abra os Ajustes da Página",
        body: "Toque no botão Ajustes da Página ao lado da barra de endereços do Safari.",
      },
      steps: [
        {
          title: "Abra o Menu da Página",
          body: "Toque no botão Menu da Página ao lado da barra de endereços do Safari.",
        },
        {
          title: "Selecione Gerenciar Extensões",
          body: "Encontre o GeoSpoof na lista e ative-o.",
        },
        {
          title: "Permita o acesso ao site",
          body: "Permita que o GeoSpoof acesse este site. O Safari pode pedir que você recarregue a página.",
        },
      ],
      permissionsBanner:
    ...
    troubleshooting: {
      summary: "O GeoSpoof não aparece?",
      items: [
        "Confirme se o GeoSpoof está na lista e ativado.",
        "Se você usa Perfis do Safari, verifique se o GeoSpoof está ativado no perfil atual.",
    ...
    checking: {
      eyebrow: "Configuração do Safari",
      heading: "Confirmando sua localização",
      status: "Lendo o que o Safari informa…",
      unavailable: "Indisponível",
    },
    error: {
      eyebrow: "O GeoSpoof está ativado",
      heading: "O Safari ainda não retornou uma localização",
      body: "Verifique se a simulação de localização está ativada no GeoSpoof e tente novamente.",
      retry: "Verificar localização novamente",
      support: "Obter ajuda",
    },
    success: {
    ...
    wrongBrowser: {
      ...
      heading: "Abra esta página no Safari",
      body: "A extensão do GeoSpoof para iPhone funciona no Safari, então esta etapa de configuração precisa ser concluída nele.",
      copyInstruction: "Copie este endereço e cole-o no Safari:",
      copied: "Endereço copiado",
      copy: "Copiar endereço de ativação",
      copyError:
        "Não é possível copiar neste navegador. Toque e segure o endereço acima para copiá-lo.",
      iosTip:
        "Dica: você também pode usar o menu Compartilhar deste navegador, copiar o link e colá-lo no Safari.",
    },
  },
  verify: {
    meta: {
  ...
  feedback: {
    meta: {
      title: "Enviar feedback — GeoSpoof",
      description:
        "Tem uma ideia, um bug para relatar ou só quer dizer oi? Envie seu feedback para a equipe do GeoSpoof — lemos cada mensagem.",
      ogTitle: "Envie feedback para o GeoSpoof",
    },
    heading: "Obrigado por usar o GeoSpoof",
    subhead:
      "O GeoSpoof é feito por uma equipe minúscula, e cada mensagem realmente ajuda a definir os próximos passos. Seja um bug, uma ideia de recurso ou só um olá, vamos adorar ouvir você.",
    emailLabel: "Envie seu feedback para",
    emailHint:
      "Copie o endereço abaixo ou toque nele para abrir seu app de e-mail.",
    copy: "Copiar",
    copied: "✓ Copiado",
    copyAria: "Copiar o endereço de e-mail para feedback",
    closing: "Obrigado por ajudar a tornar o GeoSpoof melhor.",
  },
  gps: {
    meta: {
      title: "Baixar o GeoSpoof GPS para Mac e Windows | GeoSpoof",
      description:
        "O GeoSpoof GPS é um app para Mac e Windows que ajusta a localização GPS real do iPhone conectado para corresponder à sua localização falsificada. Download gratuito, sem precisar de conta.",
      ogTitle: "Baixar o GeoSpoof GPS para Mac e Windows",
    },
    ...
    tether: {
      label: "Precisa de um computador",
      body: "Seu iPhone precisa estar conectado ao seu computador sempre que você definir ou trocar uma localização. Pode ser por USB, pela mesma rede Wi-Fi ou por um ponto de acesso. O GeoSpoof GPS é um app de computador para Mac e Windows, então não existe um modo só para iPhone.",
      link: "Como funciona a conexão",
    },
    experimental: {
      label: "Experimental",
      title: "Um recurso novo e experimental",
      body: "O GeoSpoof GPS é novo e ainda está sendo testado em diferentes dispositivos, então espere alguns detalhes ásperos e um pouco de configuração inicial. É um complemento opcional. O resto do GeoSpoof funciona bem sem ele.",
    },
    hero: {
      breadcrumbHome: "Início",
      breadcrumb: "GeoSpoof GPS",
      iconAlt: "Ícone do app GeoSpoof GPS",
      badge: "Mac e Windows",
      headingPre: "Alinhe o ",
      headingEmphasis: "GPS real",
      headingPost: " do seu iPhone com sua localização falsificada",
      intro:
        "O GeoSpoof GPS é um companheiro de computador para Mac e Windows que ajusta a localização no nível do sistema do seu iPhone para o lugar que você escolhe no GeoSpoof. Seu navegador e o GPS real do celular contam a mesma história, enquanto o celular continuar ligado ao seu computador.",
    },
    download: {
      ctaMac: "Baixar para Mac",
      ctaWindows: "Baixar para Windows",
      allPlatforms: "Todos os downloads e requisitos de sistema",
      setupCta: "Guia de configuração",
      resolving: "Buscando a versão mais recente…",
      versionLabel: "Versão mais recente",
      iosNote: "Você também vai precisar do app GeoSpoof para iPhone (Pro).",
      iosCta: "Baixar o GeoSpoof para iPhone",
    },
    downloads: {
      title: "Downloads",
      intro:
        "O GeoSpoof GPS roda no Mac e no Windows. As duas versões são gratuitas, fazem a mesma coisa e são controladas pelo mesmo app GeoSpoof no seu iPhone.",
      recommended: "Seu computador",
      macName: "macOS",
      macRequirement:
        "macOS 13 (Ventura) ou mais recente. Apple silicon ou Intel.",
      windowsName: "Windows",
      windowsRequirement: "Windows 10 ou mais recente, 64 bits.",
      proNote:
        "O download é gratuito nos dois casos. O GPS no nível do dispositivo é um recurso Pro, e o Pro é comprado no app GeoSpoof do seu iPhone, que é também onde você escolhe a localização.",
    },
    setup: {
      ...
      steps: [
        {
          name: "Instale o app",
          text: "Abra o DMG, arraste o GeoSpoof GPS para a pasta Aplicativos e abra-o. Ele roda pela barra de menus (sem ícone no Dock, sem janela) e abre o assistente de configuração na primeira vez.",
        },
        {
          name: "Permita o acesso à Rede Local",
          text: "No primeiro início, o macOS pede acesso à Rede Local. Clique em Permitir para que o GeoSpoof GPS possa encontrar seu iPhone e se comunicar com ele. Sem isso, o app não enxerga seu celular.",
          bullets: [
            "Perdeu o aviso? Ative em Ajustes do Sistema ▸ Privacidade e Segurança ▸ Rede Local ▸ GeoSpoof GPS.",
            "Um “Nenhum dispositivo encontrado” que não sai do lugar costuma indicar que essa permissão está desativada.",
          ],
        },
        {
          name: "Instale o Xcode",
          text: "O GeoSpoof GPS precisa da Imagem de Disco de Desenvolvedor da Apple, e ela vem dentro do Xcode. Inicie este download primeiro — ele é grande (vários GB), então deixe instalar em segundo plano enquanto você faz os passos rápidos do iPhone abaixo.",
          bullets: [
            "Instale o Xcode (grátis) pela Mac App Store e abra-o uma vez.",
            "Na primeira abertura, ele mostra uma tela “Selecionar plataformas”. Marque macOS e deixe as outras (incluindo iOS) desmarcadas, depois continue — você não precisa do SDK do iOS nem do Simulador; a imagem de desenvolvedor faz parte da configuração base do Xcode de qualquer forma.",
            "Deixe “Instalando componentes” terminar e feche o Xcode. Sem projeto, sem build, nada para compilar e sem conta paga de Apple Developer.",
            "Já tem uma imagem de desenvolvedor? Aponte o GeoSpoof GPS para essa pasta e pule o download do Xcode por completo.",
          ],
          link: { label: "Baixar o Xcode na Mac App Store" },
        },
        {
          name: "Conecte seu iPhone",
          text: "Conecte seu iPhone ao Mac e desbloqueie-o. Use um cabo com transferência de dados, já que alguns só carregam. Se não aparecer, tente outro cabo ou porta.",
        },
        {
          name: "Confie neste computador",
          text: "Quando o iPhone perguntar se deve confiar neste computador, toque em Confiar e digite seu código. Isso permite que o Mac e o celular se comuniquem.",
          bullets: [
            "Sem aviso? Mantenha o celular desbloqueado, depois desconecte e reconecte o cabo. O alerta só aparece com a tela desbloqueada.",
            "Ainda nada? Bloqueie e desbloqueie o celular (ou reinicie-o) e reconecte.",
            "Apenas como último recurso: Ajustes ▸ Geral ▸ Transferir ou Redefinir iPhone ▸ Redefinir ▸ Redefinir Localização e Privacidade, depois reconecte e toque em Confiar.",
          ],
        },
        {
          name: "Ative o Modo de Desenvolvedor",
          text: "No seu iPhone, vá em Ajustes ▸ Privacidade e Segurança ▸ Modo de Desenvolvedor, ative-o e reinicie quando solicitado. Ele só aparece depois de conectar o iPhone ao seu Mac pelo menos uma vez.",
        },
        {
          name: "Emparelhe com este Mac",
          text: "Na janela de configuração, clique em Emparelhar. Esse handshake seguro e único permite ao seu Mac controlar o GPS do iPhone. Mantenha o celular desbloqueado e conectado durante o processo.",
        },
        {
          name: "Prepare a imagem de desenvolvedor",
          text: "Requer o Xcode instalado (acima). Com o iPhone conectado e desbloqueado, clique em Preparar. O GeoSpoof GPS personaliza a Imagem de Disco de Desenvolvedor (DDI) da Apple para o seu dispositivo e a monta — a peça que permite a um app definir a sua localização GPS real. É assinada pela Apple e feita por você; não há nada para configurar.",
          powerUserNote:
            "Imagem não encontrada? Se o Preparar disser que não encontra a imagem de desenvolvedor, a configuração do Xcode pode não ter terminado de instalá-la. Abra o Terminal, execute isto e clique em Preparar de novo:",
        },
        {
          ...
          bullets: [
            "Você pode desconectar o cabo, mas a conexão precisa continuar. É o app de Mac que define o GPS.",
            "Vai sair sem o seu Mac? Desative o Modo de Desenvolvedor enquanto a localização está ativa e ela se mantém. Para trocá-la depois, ative o Modo de Desenvolvedor de novo, reinicie o iPhone e conecte-o novamente.",
          ],
    ...
    requirements: {
      ...
      macos: "macOS 13 (Ventura) ou mais recente.",
      appPre: "O ",
      appLink: "app do GeoSpoof para iPhone",
      appPost:
      ...
      iphone:
        "Um iPhone com o Modo de Desenvolvedor ativado, conectado por cabo USB na primeira configuração. Depois disso, ele precisa alcançar o seu Mac por cabo, pela mesma rede Wi-Fi ou por um ponto de acesso sempre que você definir ou trocar uma localização.",
    ...
    howItWorks: {
      ...
      steps: [
        {
          ...
          body: "Escolha uma localização no app GeoSpoof como sempre. Essa escolha é a única fonte da verdade, e o GeoSpoof GPS no seu computador a espelha para o seu iPhone — para que o spoof do navegador e o GPS real do dispositivo finalmente contem a mesma história.",
        },
        {
          title: "Seu computador move o GPS",
          body: "Por meio de um pareamento seguro e único, o app de computador usa a própria simulação de localização para desenvolvedores da Apple para definir a localização em nível de sistema do seu iPhone. Sem jailbreak, sem nada para compilar — o mesmo mecanismo que os desenvolvedores já usam no Xcode.",
        },
        {
          title: "Cabo uma vez, depois pela rede",
          body: "A configuração inicial é feita por cabo USB. Depois disso, o seu computador define o GPS pela rede local, seja pela mesma Wi-Fi ou por um ponto de acesso, e se reconecta sozinho quando o telefone sai da rede e entra novamente. Quem faz o trabalho continua sendo o seu computador, então ele precisa ficar conectado.",
        },
        {
      ...
      privacyTitle: "Só seu",
      privacyBody:
        "Tudo acontece diretamente entre o seu computador e o seu iPhone, então sua localização nunca passa pelos nossos servidores. O Pro é verificado com recibos assinados pela Apple, e a versão para Mac é autenticada pela Apple e tem a assinatura conferida em cada atualização.",
    },
    connection: {
      title: "A ligação com o seu computador",
      intro:
        "É o seu computador que define o GPS, então os dois dispositivos precisam estar conectados quando você define ou troca uma localização. Qualquer uma destas opções funciona:",
      links: [
        {
          title: "Cabo USB",
        ...
        },
        {
          ...
          body: "Depois do primeiro pareamento, o seu computador consegue encontrar o telefone pela rede local, sem precisar de cabo. Os dois dispositivos precisam estar na mesma rede.",
        },
        {
          title: "Um ponto de acesso",
          body: "Sem Wi-Fi em comum? Ligue o Acesso Pessoal do seu iPhone e conecte o computador a ele. O contrário também funciona, com o computador compartilhando a conexão com o telefone.",
        },
      ],
      offlineTitle: "Sair sem o seu computador",
      offlineBody:
        "Uma localização pode continuar valendo depois que a conexão termina. Com a sua localização falsificada ativa, desative o Modo de Desenvolvedor no iPhone (Ajustes ▸ Privacidade e Segurança ▸ Modo de Desenvolvedor). Dali em diante a localização se mantém, inclusive depois de você se afastar do computador.",
      offlineCaveat:
        "A contrapartida é que a localização fica fixa. Para escolher outra, ative o Modo de Desenvolvedor de novo, reinicie o iPhone e defina a nova com o seu computador perto de você.",
      limitTitle: "O que não dá para fazer",
      limitBody:
        "Nada passa pelos nossos servidores, então o seu computador não consegue alcançar o iPhone pela internet. Uma vez separados, o telefone para de aceitar novas localizações. O passo do Modo de Desenvolvedor acima é o que mantém a atual no lugar.",
    },
    menuShotAlt: "App GeoSpoof GPS no macOS",
    trayShotAlt:
      "GeoSpoof GPS na área de notificação do Windows, com o painel aberto",
    trayHintMac:
      "O GeoSpoof GPS não tem janela. Ele fica na barra de menus — clique no alfinete perto do relógio para abrir o painel.",
    trayHintWindows:
      "O GeoSpoof GPS não tem janela. Ele fica na área de notificação — se você não vê o alfinete, clique na seta da barra de tarefas para mostrar os ícones ocultos.",
    screenshotAlt: "GeoSpoof GPS no iPhone, captura {n}",
    help: {
      title: "Ainda travado?",
      body: "Se um passo não for concluído, nossa página de suporte tem mais soluções. Encontrou um bug ou tem uma ideia? Vamos adorar saber.",
