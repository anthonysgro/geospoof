...
export const es: Dictionary = {
  ...
  hero: {
    ...
    headlinePost: " empezó",
    subhead:
      "Una VPN cambia tu IP, pero tus dispositivos siguen revelando tu ubicación real. GeoSpoof remata la faena: desde tu navegador hasta el GPS real de tu iPhone.",
    ...
    gpsBadge: "Nuevo",
    gpsHint: "Cambia el GPS real de tu iPhone",
  ...
  products: {
    eyebrow: "Dos apps",
    heading: "GeoSpoof y GeoSpoof GPS",
    subhead:
      "GeoSpoof es la app que instalas para controlar lo que ven los sitios. GeoSpoof GPS es el complemento de escritorio gratuito que lleva todo esto fuera del navegador, al GPS real de tu iPhone.",
    availableOn: "Disponible en",
    requires: "Necesita",
    app: {
      badge: "Gratis",
      title: "GeoSpoof",
      tagline: "Extensión de navegador y app móvil",
      description:
        "Falsea tu geolocalización, zona horaria y WebRTC para que los sitios vean el lugar que elijas en vez de dónde estás. Sin cuenta, sin rastreo.",
      platforms: "Chrome, Firefox, Edge, Brave, Safari, iPhone, iPad, Mac",
    },
    gps: {
      badge: "App complementaria gratuita",
      title: "GeoSpoof GPS",
      tagline: "App de barra de menús para Mac y Windows",
      description:
        "Va más allá del navegador y ajusta el GPS real, de nivel de sistema, de tu iPhone al lugar que elijas en GeoSpoof. Vive en la barra de menús: ninguna ventana que gestionar.",
      platforms: "macOS, Windows",
      requirement:
        "GeoSpoof Pro en tu iPhone, y tu iPhone conectado al ordenador cuando fijes una ubicación",
      cta: "Obtener GeoSpoof GPS",
    },
    pro: {
      badge: "Pro",
      title: "GeoSpoof Pro",
      description:
        "Pro es una mejora dentro de la app de iPhone, no una tercera descarga. Es lo que desbloquea el GPS a nivel de dispositivo que controla GeoSpoof GPS, más sincronización automática con VPN, widgets, selector de mapa y filtros por sitio.",
  ...
  pro: {
    meta: {
      title: "GeoSpoof Pro — Gratis vs. Pro, precios y funciones | GeoSpoof",
      description:
        "Compara GeoSpoof gratis con GeoSpoof Pro. Pro desbloquea el GPS real del sistema de tu iPhone, rutas GPX, resincronización automática de VPN, reglas por sitio, widgets y más. $1.99/mes, $9.99/año o $24.99 una vez — facturado a través de la App Store.",
      ogTitle: "GeoSpoof Pro — Gratis vs. Pro, precios y funciones",
    },
    hero: {
      ...
      subhead:
        "Falsear tu ubicación, tu zona horaria y WebRTC es gratis. Pro añade las herramientas avanzadas en iPhone y iPad, empezando por el GPS real y de sistema de tu dispositivo.",
      ctaPrimary: "Obtener GeoSpoof Pro",
      ctaSecondary: "Comparar Gratis y Pro",
      trust: "Sin cuenta · Sin rastreo · Código abierto",
    },
    plans: {
      eyebrow: "Gratis vs. Pro",
      heading: "Lo que obtienes en cualquier caso",
      subhead:
        "El núcleo del falseo es gratis: todos los sitios, una zona horaria coincidente y cero fugas de WebRTC. Pro va de potencia y comodidad, nunca de retener tu privacidad.",
      featureHeader: "Función",
      freeHeader: "Gratis",
      proHeader: "Pro",
      bothValue: "Gratis y Pro",
      proOnlyValue: "Solo Pro",
      rows: {
        spoofing: "Ubicación falsa en todos los sitios",
        timezoneWebrtc: "Zona horaria coincidente y protección WebRTC",
        vpnSync:
          "Sincronización VPN, búsqueda de ciudades, coordenadas exactas",
        deviceGps: "El GPS real del sistema de tu iPhone",
        routes: "Sigue rutas GPX a un ritmo real",
        offlineHold: "Mantiene la ubicación cuando te alejas del ordenador",
        autoResync: "Resincronización automática de VPN",
        perSite: "Reglas por sitio, precisión e idioma",
        widgets: "Widgets y controles",
      },
      legend: {
        both: "En ambos planes",
        proOnly: "Solo Pro",
      },
      scopeNote:
        "Esta comparación es de la app para iPhone y iPad. Las extensiones para Chrome, Firefox, Edge y Brave son gratis, igual que GeoSpoof GPS para Mac y Windows.",
    },
    unlocks: {
      eyebrow: "Qué desbloquea Pro",
      heading: "Las mejoras, en detalle",
      subhead:
        "Todas existen porque la vía gratuita ya funciona. Estas son las razones por las que la gente mejora a Pro.",
      items: {
        gps: {
          title: "GPS del dispositivo",
          body: "Fija la ubicación real y de sistema que informa tu iPhone: a Mapas, a Tiempo, a cualquier app que la pida. Necesita la app gratuita GeoSpoof GPS en un Mac o un PC con Windows.",
        },
        routes: {
          title: "Rutas GPX",
          body: "Importa una ruta y síguela a un ritmo realista, con una posición en vivo que avanza por el trazado. Pausa, reanuda, empieza de nuevo o repítela en bucle.",
        },
        offlineHold: {
          title: "Deja el ordenador atrás",
          body: "Desactiva el modo de desarrollador con una ubicación puesta y tu iPhone la mantiene después de que termine el enlace con el ordenador. Mientras aguanta, la ubicación queda fija.",
        },
        autoResync: {
          title: "Resincronización automática de VPN",
          body: "Tu ubicación sigue la región de salida de tu VPN en segundo plano, cada vez que cambia el nodo de salida y sin que toques nada.",
        },
        perSite: {
          title: "Reglas por sitio y ajuste fino",
          body: "Listas de permitidos y bloqueados para falsear solo los sitios que elijas, además de precisión, ubicación aproximada e idioma.",
        },
        mapPicker: {
          title: "Selector en el mapa",
          body: "Coloca un pin en cualquier punto del mapa y úsalo como tu ubicación, en lugar de escribir coordenadas.",
        },
        widgets: {
          title: "Widgets y controles",
          body: "Cambia de ubicación desde la pantalla de inicio, la pantalla de bloqueo o el centro de control, sin abrir la app.",
        },
        future: {
          title: "Y habrá más",
          body: "Las nuevas funciones Pro entran en la misma compra, en cuanto se lanzan.",
        },
      },
    },
    pricing: {
      eyebrow: "Precios",
      heading: "Una compra, todos tus dispositivos Apple",
      subhead:
        "Elige el plan dentro de la app. Pro desbloquea iPhone, iPad y Mac con la misma cuenta de Apple: no hay cuenta que crear ni sesión que iniciar.",
      cta: "Obtener GeoSpoof Pro",
      universal: "Una compra desbloquea iPhone, iPad y Mac.",
      fineprint:
        "Facturación a través de la App Store. Precios en USD; Apple cobra el precio local con impuestos incluidos. Cancela cuando quieras.",
      lifetimeNote:
        "De por vida es una compra única. No es una suscripción y no se renueva.",
      monthly: {
        name: "Mensual",
        price: "$1.99",
        period: "/mes",
    ...
    requirements: {
      ...
      computer:
        "El GPS del dispositivo necesita un Mac o un PC con Windows: se empareja una vez con cable y luego funciona por Wi-Fi. El resto de funciones Pro funcionan solo con el teléfono.",
      arGames:
        "No sirve para juegos de RA como Pokémon GO: el GPS del dispositivo es para privacidad, navegación y desarrollo.",
      extensions:
        "Las extensiones de navegador para Chrome, Firefox, Edge y Brave son gratis y no forman parte de Pro.",
    },
    faq: {
      heading: "Preguntas sobre Pro",
      items: [
        {
          q: "¿GeoSpoof es gratis?",
          a: "Sí. La extensión de navegador es gratis en todos los navegadores principales, y la app para iPhone y iPad falsea tu ubicación, tu zona horaria y WebRTC sin coste, incluidas la sincronización VPN con un toque, la búsqueda de ciudades y las coordenadas exactas. Pro añade el GPS del dispositivo y los controles avanzados.",
        },
        {
          q: "¿Necesito un Mac o un PC para usar Pro?",
          a: "Solo para el GPS del dispositivo. GeoSpoof GPS es una app complementaria gratuita para Mac y Windows: se empareja una vez con cable y luego funciona por Wi-Fi. Cualquier otra función Pro funciona sola en el teléfono.",
        },
        {
          q: "¿Cuántos dispositivos cubre una compra?",
          a: "Es una compra universal: iPhone, iPad y Mac quedan cubiertos con la misma cuenta de Apple. El derecho viaja con tu cuenta de Apple, sin inicio de sesión ni restauraciones en el segundo dispositivo.",
        },
        {
          q: "¿Puedo pagar una sola vez en lugar de suscribirme?",
          a: "Sí. El desbloqueo de por vida de $24.99 es una compra única. No es una suscripción y nunca se renueva.",
        },
        {
          q: "¿El GPS del dispositivo sirve para Pokémon GO?",
          a: "No. El GPS del dispositivo está hecho para privacidad, navegación y desarrollo, y no damos soporte a juegos de RA.",
        },
        {
          q: "¿Cómo cancelo?",
          a: "En la app Ajustes, dentro de tu cuenta de Apple y luego Suscripciones. Pro sigue funcionando hasta el final del periodo que ya has pagado.",
        },
      ],
      gpsLead: "¿Quieres primero los detalles del GPS del dispositivo? ",
      gpsLink: "Lee sobre GeoSpoof GPS",
      gpsTail: ", la app de escritorio gratuita que lo mueve.",
    },
  },
  footer: {
    groups: {
    ...
    links: {
      geospoofIos: "GeoSpoof para iPhone y iPad",
    ...
    copyright: "© {year} GeoSpoof LLC. Todos los derechos reservados.",
  },
  languageSwitcher: {
    label: "Idioma",
  ...
  comparison: {
    ...
    subhead:
      "La mayoría de los falseadores de ubicación hacen una sola cosa: colocar una latitud y una longitud falsas en el navegador. GeoSpoof cubre toda la señal, para que tu ubicación, tu zona horaria y tu IP cuenten la misma historia. Y el núcleo es gratis.",
    featureHeader: "Función",
  ...
  compatibility: {
    ...
    footnote:
      "Firefox para Android requiere Firefox 140+. Safari requiere iOS 18+ o macOS 13+.",
  ...
  vpn: {
    ...
    hero: {
      ...
      partnerPricing: "Hasta {discount} de descuento para socios",
      learnMore: "Saber más",
    ...
    plan: {
      ...
      unlimitedPre:
        "¿Ya tienes una VPN o quieres más que una herramienta? El plan ",
      unlimitedLink: "Unlimited de Proton",
      unlimitedPost: " combina VPN con Mail, Pass, Drive y Calendar.",
    },
    inlineDisclosure:
  ...
  support: {
    ...
    subhead:
      "La mayoría de los reportes se deben a una de las causas de abajo. Recorre la lista y detente cuando el falseo funcione.",
    symptomsLead: "¿Qué está pasando?",
    symptoms: [
      {
        label: "El falseo de ubicación no funciona",
        target: "troubleshooting",
      },
      {
        label: "La Sincronización con VPN falla o expira",
        target: "faq-vpn-sync",
      },
      {
        label: "Funciona en el escritorio pero no en mi teléfono",
        target: "faq-mobile",
      },
      { label: "Otra cosa", target: "questions" },
    ],
    lastUpdatedLabel: "Última actualización",
    troubleshooting: {
      title: "El falseo no funciona en un sitio",
      intro:
        "Están ordenados de más a menos común. Probablemente no necesites llegar al final.",
      browserNote:
        "GeoSpoof también funciona en Chrome, Edge, Brave y Safari. Los pasos de abajo están escritos para Firefox, donde estos conflictos son más comunes — en otros navegadores, aplica los ajustes equivalentes.",
      latestReleaseLabel: "Última versión",
      latestReleaseCta: "Ver la última versión en GitHub",
      badgeActiveLabel: "Activo en esta pestaña",
      badgeActiveAlt:
        "Icono de GeoSpoof en la barra de herramientas con una insignia que indica que está activo en la pestaña actual",
      badgeDisabledLabel: "No se está ejecutando en esta pestaña",
      badgeDisabledAlt:
        "Icono de GeoSpoof en la barra de herramientas con una insignia que indica que no se está ejecutando en la pestaña actual",
      geolocationDeniedAlt:
        'El resultado de una prueba de huella digital que informa "Geolocation: Denied" porque Firefox bloqueó la solicitud de ubicación',
      geolocationDeniedCaption:
        "Así se ve una solicitud de ubicación bloqueada en una prueba de huella digital.",
      preserveOffAlt:
        'El popup de GeoSpoof con el interruptor "Conservar avisos de ubicación" desactivado',
      preserveOffCaption:
        'Popup de GeoSpoof con "Conservar avisos de ubicación" desactivado.',
      tzpCta: "Abrir la prueba TZP",
      featuredLabel: "Mejor diagnóstico",
      steps: [
        {
          title: "Actualiza la pestaña, o vuelve a abrirla",
          featured: false,
          body: "GeoSpoof solo surte efecto en las páginas cargadas después de activarlo. Cualquier pestaña que ya estuviera abierta cuando instalaste, actualizaste o reactivaste GeoSpoof no se falseará hasta que se recargue. Actualiza la pestaña que estás probando — si eso no ayuda, ciérrala y vuelve a abrirla.",
          details: [],
          note: "",
          action: "",
        },
        ...
        {
          title: "Confirma que GeoSpoof se está ejecutando en el sitio",
          featured: false,
          body: "El icono de GeoSpoof en la barra de herramientas indica si está activo en la pestaña actual. Si no está activo, no se falsea nada — casi siempre por el alcance de sitios definido en la pestaña Filtros.",
          details: [
            "Modo Lista de permitidos: solo se falsean los sitios de la lista — añade el sitio que estás probando.",
            "Modo Lista de bloqueados: asegúrate de que el sitio no esté en la lista.",
            'O cambia a "Todos" para falsear en todas partes.',
          ],
          note: "",
          action: "badgeCheck",
        },
        {
          title: "Restablece el permiso de ubicación del sitio",
          featured: false,
          body: 'Si una prueba informa "Geolocation: Denied", Firefox está bloqueando la solicitud — normalmente porque el aviso se rechazó una vez con "Recordar esta decisión" marcado.',
          details: [
            "Haz clic en el icono del candado en la barra de direcciones.",
            "Borra cualquier Bloqueo recordado para la ubicación, luego recarga la página.",
            'En los ajustes de Firefox, confirma que "Bloquear las nuevas solicitudes de acceso a tu ubicación" está desactivado.',
            'Si el interruptor "Conservar avisos de ubicación" de GeoSpoof está activado y rechazaste el aviso, permítelo o desactiva el interruptor para que GeoSpoof responda directamente.',
          ],
          note: "",
          action: "geolocationDenied",
        },
        {
          title: "Reinicia el navegador",
          featured: false,
          body: "Algunas API del navegador se configuran al arrancar, así que una instalación, actualización o cambio de ajustes reciente puede no surtir efecto hasta que cierres y vuelvas a abrir el navegador por completo.",
          details: [],
          note: "",
          action: "",
        },
        {
          title: "Prueba en un perfil nuevo de Firefox",
          featured: true,
          body: "Un perfil limpio aísla GeoSpoof de tu configuración actual.",
          details: [
            "Abre about:profiles y crea un perfil nuevo.",
            "Inícialo, instala GeoSpoof y prueba el mismo sitio de nuevo.",
          ],
          note: "Si el falseo funciona en el perfil limpio, GeoSpoof en sí está bien — algo en tu perfil normal está interfiriendo, casi siempre una herramienta de privacidad o un cambio en about:config. Los dos pasos siguientes cubren esos casos.",
          action: "",
        },
        {
          title: "Desactiva las herramientas de privacidad en conflicto",
          featured: false,
          body: "Las herramientas de endurecimiento cambian muchas de las mismas API del navegador que GeoSpoof y pueden anularlo. Desactiva temporalmente las que uses y vuelve a intentarlo: Arkenfox, Betterfox, LibreWolf, CanvasBlocker, JShelter, Chameleon, Trace o cualquier aleatorizador de huella digital.",
          details: [],
          note: "",
          action: "",
        },
        {
          title: "Revisa about:config (avanzado)",
          featured: false,
          body: "Si has endurecido Firefox, confirma que estas preferencias están desactivadas, luego reinicia y vuelve a intentarlo. La Protección contra el rastreo mejorada en modo estricto suele estar bien y no necesita cambios.",
          details: [
        ...
        {
          title: "Confirma en una segunda prueba de huella digital",
          featured: false,
          body: "Las pruebas miden distintas API y algunas simplemente tienen fallos. Antes de asumir que GeoSpoof es el culpable, verifica el resultado en otra prueba reputada — recomendamos la sección Region del TZP de arkenfox.",
          details: [],
          note: "",
          action: "tzpTest",
        },
    ...
    commonIssues: "Otras preguntas frecuentes",
    faqs: [
      {
        id: "vpn-sync",
    ...
    contactChecklistLead: "Incluye esto para que podamos ayudarte más rápido:",
    contactChecklist: [
      "Versión de Firefox",
      "Sistema operativo",
      "Versión de GeoSpoof",
      "Proveedor de VPN (si aplica)",
      "El sitio de prueba de huella digital que usas",
      "Una captura de pantalla del resultado",
      "Si el falseo funciona en un perfil nuevo de Firefox",
    ],
  ...
  activate: {
    meta: {
      title: "Activar GeoSpoof en Safari",
      description:
        "Activa la extensión GeoSpoof en Safari y confirma la ubicación que comunica Safari.",
    },
      ...
      steps: [
        {
          ...
          body: "Toca el botón del menú de la página junto a la barra de direcciones de Safari.",
        },
        {
          title: "Selecciona Gestionar extensiones",
          body: "Busca GeoSpoof en la lista y actívalo.",
        },
        {
          title: "Permite el acceso al sitio web",
    ...
    troubleshooting: {
      ...
      items: [
        "Comprueba que GeoSpoof aparezca en la lista y esté activado.",
        "Si usas perfiles de Safari, asegúrate de que GeoSpoof esté activado en el perfil actual.",
      ...
      appleSupport: "¿Tienes problemas? Consulta las instrucciones de Apple",
    },
    checking: {
      eyebrow: "Configuración de Safari",
      heading: "Confirmando tu ubicación",
      status: "Leyendo lo que comunica Safari…",
      unavailable: "No disponible",
    },
    error: {
      eyebrow: "GeoSpoof está activado",
      heading: "Safari aún no ha devuelto una ubicación",
      body: "Asegúrate de que la simulación de ubicación esté activada en GeoSpoof y vuelve a intentarlo.",
      retry: "Comprobar de nuevo la ubicación",
      support: "Obtener ayuda",
    },
    success: {
      status: "Safari está listo",
      heading: "GeoSpoof funciona en Safari",
      locationLabel: "Ubicación comunicada por Safari",
      timezoneLabel: "Zona horaria comunicada",
      returnToApp: "Volver a GeoSpoof",
      fullVerification: "Ejecutar la verificación completa",
    },
    desktop: {
      heading: "Configura GeoSpoof desde la app para Mac",
      body: "Esta página explica la configuración en el iPhone. En un Mac, abre GeoSpoof y usa «Activar en Safari»: te lleva directamente a los ajustes de extensiones de Safari.",
    },
    wrongBrowser: {
      eyebrow: "Safari es necesario",
      heading: "Abre esta página en Safari",
      body: "La extensión para iPhone de GeoSpoof funciona en Safari, por lo que este paso de configuración debe completarse allí.",
      copyInstruction: "Copia esta dirección y pégala en Safari:",
      copied: "Dirección copiada",
      copy: "Copiar dirección de activación",
      copyError:
        "Este navegador no permite copiar. Mantén pulsada la dirección de arriba para copiarla.",
      iosTip:
        "Consejo: también puedes usar el menú Compartir de este navegador, copiar el enlace y pegarlo en Safari.",
    },
  },
  verify: {
    meta: {
    ...
    vpnCard: {
      ...
      cta: "Protege tu IP con Proton VPN",
      priceNote: "Hasta {discount} de descuento",
      guaranteeNote: "Garantía de 30 días",
    },
    apiSection: {
  ...
  gps: {
    meta: {
      title: "Descargar GeoSpoof GPS para Mac y Windows | GeoSpoof",
      description:
        "GeoSpoof GPS es una app para Mac y Windows que ajusta la ubicación GPS real de tu iPhone conectado para que coincida con tu ubicación falseada. Descarga gratuita, sin necesidad de cuenta.",
      ogTitle: "Descargar GeoSpoof GPS para Mac y Windows",
    },
    preflightTitle: "Antes de descargar",
    compat: {
      label: "No para juegos de RA",
      body: "GeoSpoof GPS está diseñado exclusivamente para la privacidad, la navegación web y el desarrollo. No es compatible con juegos móviles de realidad aumentada como Pokémon GO, ni está diseñado para ellos.",
    },
    tether: {
      label: "Necesita un ordenador",
      body: "Tu iPhone tiene que estar conectado a tu ordenador siempre que fijes o cambies una ubicación. Puede ser por USB, por la misma red Wi-Fi o por un punto de acceso. GeoSpoof GPS es una app de escritorio para Mac y Windows, así que no existe un modo solo para iPhone.",
    ...
    hero: {
      ...
      intro:
        "GeoSpoof GPS es un complemento de escritorio para Mac y Windows que ajusta la ubicación a nivel de sistema de tu iPhone al lugar que eliges en GeoSpoof. Tu navegador y el GPS real de tu teléfono cuentan la misma historia, mientras el teléfono siga conectado a tu ordenador.",
    },
    download: {
      ctaMac: "Descargar para Mac",
      ctaWindows: "Descargar para Windows",
      allPlatforms: "Todas las descargas y requisitos del sistema",
      setupCta: "Guía de configuración",
      resolving: "Buscando la última versión…",
      versionLabel: "Última versión",
      iosNote: "También necesitarás la app GeoSpoof para iPhone (Pro).",
      iosCta: "Obtener GeoSpoof para iPhone",
    },
    downloads: {
      title: "Descargas",
      intro:
        "GeoSpoof GPS funciona en Mac y en Windows. Las dos versiones son gratuitas, hacen lo mismo y se controlan desde la misma app de GeoSpoof en tu iPhone.",
      recommended: "Tu ordenador",
      macName: "macOS",
      macRequirement: "macOS 13 (Ventura) o posterior. Apple silicon o Intel.",
      windowsName: "Windows",
      windowsRequirement: "Windows 10 o posterior, 64 bits.",
      proNote:
        "La descarga es gratuita en ambos casos. El GPS a nivel de dispositivo es una función Pro, y Pro se compra en la app de GeoSpoof de tu iPhone, que es también donde eliges la ubicación.",
    },
    setup: {
      title: "Configura GeoSpoof GPS",
      intro:
        "Abre el icono de la barra de menús y elige «Configurar…». El asistente marca cada paso a medida que avanzas. Conecta tu iPhone con un cable para terminar la configuración; después tu Mac puede mover el GPS por Wi-Fi o por un punto de acceso, siempre que los dos se sigan alcanzando.",
      steps: [
        {
          name: "Instala la app",
        ...
        {
          name: "Instala Xcode",
          text: "GeoSpoof GPS necesita la imagen de disco de desarrollador de Apple, y viene dentro de Xcode. Empieza esta descarga primero: es grande (varios GB), así que déjala instalarse en segundo plano mientras haces los pasos rápidos del iPhone de abajo.",
          bullets: [
            "Instala Xcode (gratis) desde la Mac App Store y ábrelo una vez.",
            "En el primer arranque muestra una pantalla de “Seleccionar plataformas”. Marca macOS y deja el resto (incluida iOS) sin marcar, luego continúa: no necesitas el SDK de iOS ni el Simulador; la imagen de desarrollador forma parte de la configuración base de Xcode de todos modos.",
            "Deja que termine “Instalando componentes” y cierra Xcode. Sin proyecto, sin compilación, nada que construir y sin cuenta de pago de Apple Developer.",
            "¿Ya tienes una imagen de desarrollador? Indica esa carpeta a GeoSpoof GPS y sáltate por completo la descarga de Xcode.",
          ],
        ...
        },
        {
          ...
          text: "Requiere Xcode instalado (arriba). Con tu iPhone conectado y desbloqueado, haz clic en Preparar. GeoSpoof GPS personaliza la imagen de disco de desarrollador (DDI) de Apple para tu dispositivo y la monta: la pieza que permite a una app fijar tu ubicación GPS real. Está firmada por Apple y se hace por ti; no hay nada que configurar.",
          powerUserNote:
            "¿No encuentra la imagen? Si Preparar dice que no encuentra la imagen de desarrollador, puede que la configuración de Xcode no haya terminado de instalarla. Abre la Terminal, ejecuta esto y vuelve a hacer clic en Preparar:",
        },
        {
    ...
    requirements: {
      ...
      macos: "macOS 13 (Ventura) o posterior.",
      appPre: "La ",
    ...
    howItWorks: {
      title: "Cómo funciona",
      intro:
        "Una ubicación coherente en tu navegador y en tu teléfono, gestionada por completo desde la app de GeoSpoof que ya usas.",
      steps: [
        {
          title: "Tú eliges, él sigue",
          body: "Elige una ubicación en la app de GeoSpoof como siempre. Esa elección es la única fuente de verdad, y GeoSpoof GPS en tu ordenador la refleja en tu iPhone, para que el spoof del navegador y el GPS real del dispositivo cuenten por fin la misma historia.",
        },
        {
          title: "Tu ordenador mueve el GPS",
          body: "Mediante un emparejamiento seguro y único, la app de escritorio usa la propia simulación de ubicación para desarrolladores de Apple para fijar la ubicación a nivel de sistema de tu iPhone. Sin jailbreak, sin nada que compilar: el mismo mecanismo que los desarrolladores ya usan en Xcode.",
        },
        {
          title: "Cable una vez, luego por la red",
          body: "La configuración inicial se hace con un cable USB. Después tu ordenador fija el GPS por la red local, ya sea la misma Wi-Fi o un punto de acceso, y se reconecta solo cuando tu teléfono sale de la red y vuelve a ella. El trabajo lo sigue haciendo tu ordenador, así que tiene que seguir conectado.",
        },
        {
          title: "Se mantiene firme, revierte limpio",
          body: "La app mantiene tu ubicación fija y cambia al instante cuando eliges otra. Pausa la sincronización o cierra la app, y tu iPhone vuelve de inmediato a su GPS real, sin ningún spoof residual.",
        },
      ],
      privacyTitle: "Solo tuyo",
      privacyBody:
        "Todo ocurre directamente entre tu ordenador y tu iPhone, así que tu ubicación nunca pasa por nuestros servidores. Pro se verifica con recibos firmados por Apple, y la versión para Mac está certificada por Apple y se comprueba su firma en cada actualización.",
    },
    connection: {
      title: "El enlace con tu ordenador",
      intro:
        "Tu ordenador es lo que fija el GPS, así que los dos dispositivos tienen que estar conectados cuando fijas o cambias una ubicación. Cualquiera de estas opciones funciona:",
      links: [
        {
          title: "Cable USB",
          body: "La opción más fiable y la que usa la primera configuración. Usa un cable con datos y mantén el teléfono desbloqueado.",
        },
        {
          title: "La misma red Wi-Fi",
          body: "Tras el primer emparejamiento, tu ordenador puede encontrar el teléfono por la red local, sin necesidad de cable. Los dos dispositivos tienen que estar en la misma red.",
        },
        {
          title: "Un punto de acceso",
          body: "¿No hay Wi-Fi compartida? Activa el Punto de acceso personal de tu iPhone y conecta tu ordenador a él. También funciona al contrario, con tu ordenador compartiendo su conexión con el teléfono.",
        },
      ],
      offlineTitle: "Salir sin tu ordenador",
      offlineBody:
    ...
    menuShotAlt: "App GeoSpoof GPS en macOS",
    trayShotAlt:
      "GeoSpoof GPS en el área de notificación de Windows, con su panel abierto",
    trayHintMac:
      "GeoSpoof GPS no tiene ventana. Vive en la barra de menús: haz clic en el pin junto al reloj para abrir el panel.",
    trayHintWindows:
      "GeoSpoof GPS no tiene ventana. Vive en el área de notificación: si no ves el pin, haz clic en la flecha de la barra de tareas para mostrar los iconos ocultos.",
