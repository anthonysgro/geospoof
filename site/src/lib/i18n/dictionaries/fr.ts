...
export const fr: Dictionary = {
  ...
  hero: {
    ...
    subhead:
      "Un VPN change votre adresse IP, mais vos appareils dévoilent toujours votre véritable position. GeoSpoof termine le travail — de votre navigateur au vrai GPS de votre iPhone.",
  ...
  products: {
    eyebrow: "Deux apps",
    heading: "GeoSpoof et GeoSpoof GPS",
    subhead:
      "GeoSpoof est l’app que vous installez pour contrôler ce que voient les sites. GeoSpoof GPS est le compagnon de bureau gratuit qui sort du navigateur pour agir sur le vrai GPS de votre iPhone.",
    availableOn: "Disponible sur",
    requires: "Nécessite",
    app: {
      badge: "Gratuit",
      title: "GeoSpoof",
      tagline: "Extension de navigateur et app mobile",
      description:
        "Simulez votre géolocalisation, votre fuseau horaire et le WebRTC pour que les sites voient le lieu que vous choisissez plutôt que le vôtre. Sans compte, sans traçage.",
      platforms: "Chrome, Firefox, Edge, Brave, Safari, iPhone, iPad, Mac",
    },
    gps: {
      badge: "App compagnon gratuite",
      title: "GeoSpoof GPS",
      tagline: "App de barre de menus pour Mac et Windows",
      description:
        "Va au-delà du navigateur et règle le vrai GPS système de votre iPhone sur le lieu choisi dans GeoSpoof. Elle vit dans la barre de menus — aucune fenêtre à gérer.",
      platforms: "macOS, Windows",
      requirement:
        "GeoSpoof Pro sur votre iPhone, et votre iPhone connecté à l’ordinateur au moment où vous définissez une position",
      cta: "Obtenir GeoSpoof GPS",
    },
    pro: {
      badge: "Pro",
      title: "GeoSpoof Pro",
      description:
        "Pro est une amélioration dans l’app iPhone, pas un troisième téléchargement. C’est ce qui débloque le GPS au niveau de l’appareil piloté par GeoSpoof GPS, plus la synchronisation VPN automatique, les widgets, le sélecteur sur carte et les filtres par site.",
  ...
  footer: {
    ...
    links: {
      geospoofIos: "GeoSpoof pour iPhone et iPad",
  ...
  comparison: {
    ...
    subhead:
      "La plupart des outils de simulation ne font qu’une chose : injecter une fausse latitude et une fausse longitude dans le navigateur. GeoSpoof couvre l’ensemble du signal, pour que votre position, votre fuseau horaire et votre IP racontent tous la même histoire — et l’essentiel est gratuit.",
    featureHeader: "Fonctionnalité",
  ...
  compatibility: {
    ...
    footnote:
      "Firefox pour Android nécessite Firefox 140+. Safari nécessite iOS 18+ ou macOS 13+.",
    setupLead:
  ...
  activate: {
    ...
    waiting: {
      ...
      heading: "Terminez la configuration de Safari",
      body: "Activez GeoSpoof dans Safari. Nous continuerons automatiquement.",
      status: "En attente de GeoSpoof sur cette page…",
      notActive: "GeoSpoof n’est pas encore actif sur cette page.",
      onLabel: "Activé",
  ...
  gps: {
    ...
    setup: {
      ...
      intro:
        "Ouvrez l'icône de la barre de menus et choisissez « Configurer… ». L'assistant coche chaque étape au fur et à mesure. Connectez votre iPhone avec un câble pour terminer la configuration ; ensuite votre Mac peut piloter le GPS en Wi-Fi ou via un partage de connexion, tant que les deux restent à portée l'un de l'autre.",
      steps: [
        {
    ...
    connection: {
      ...
      links: [
        {
          title: "Câble USB",
          body: "L'option la plus fiable, et celle qu'utilise la première configuration. Prenez un câble compatible données et gardez le téléphone déverrouillé.",
        },
        {
