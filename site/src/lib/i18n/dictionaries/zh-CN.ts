...
export const zhCN: Dictionary = {
  ...
  comparison: {
    ...
    heading: "不只是替换坐标",
    subhead:
      "大多数位置伪造工具只做一件事：给浏览器塞一个假的经纬度。GeoSpoof 覆盖整个信号，让你的位置、时区和 IP 都讲同一个故事——而且核心功能免费。",
    featureHeader: "功能",
    typicalHeader: "其他扩展",
    freeHeader: "免费",
    proHeader: "Pro",
    ...
    troubleshooting: {
      ...
      steps: [
        ...
        },
        {
          title: "更新到最新版本",
          featured: false,
          body: "许多问题在较新的发行版中已经修复。在弹窗中点击标题栏的齿轮图标打开“设置”查看你的版本，然后与下方的最新发行版对比；如果落后了，请通过浏览器的扩展管理器更新。",
          details: [],
          note: "",
  ...
  gps: {
      ...
      steps: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "要出门但不带 Mac？在位置生效时关闭开发者模式，该位置就会保留下来。之后若要更改，请重新开启开发者模式、重启 iPhone 并重新连接。",
          ],
    ...
    connection: {
      ...
      offlineCaveat:
        "代价是这个位置已经固定下来。要换成另一个位置，需要重新开启开发者模式、重启 iPhone，并在电脑回到身边时设置新位置。",
      limitTitle: "做不到的事",
      limitBody:
