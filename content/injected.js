...
(function() {
  ...
  window.addEventListener("__geospoof_settings_update", (event) => {
    if (event.detail) {
      ...
      if (event.detail.timezone) {
        if (validateTimezoneData(event.detail.timezone)) {
          ...
          console.error("[GeoSpoof Injected] Invalid timezone data received, timezone spoofing disabled");
          timezoneData = null;
        }
      } else {
        timezoneData = null;
      ...
      console.log("[GeoSpoof Injected] Settings updated via event:", { spoofingEnabled, spoofedLocation, timezoneData });
    }
  });
  ...
  navigator.geolocation.getCurrentPosition = function(successCallback, errorCallback, options) {
    console.log("[GeoSpoof Injected] getCurrentPosition called. Enabled:", spoofingEnabled, "Location:", spoofedLocation);
  ...
  try {
    ...
    console.error('[GeoSpoof Injected] Failed to override Intl.DateTimeFormat.resolvedOptions:', error);
  }
