...
function updateInjectedScript() {
  ...
  try {
    ...
    console.log("[GeoSpoof Content] Dispatched settings update event:", { spoofingEnabled, spoofedLocation, timezoneOverride });
  } catch (error) {
...
browser.runtime.onMessage.addListener((message) => {
  ...
  if (message.type === "UPDATE_SETTINGS") {
    ...
    console.log("[GeoSpoof Content] Settings updated. Enabled:", spoofingEnabled, "Location:", spoofedLocation);
    updateInjectedScript();
...
browser.runtime.sendMessage({ type: "GET_SETTINGS" }).then((settings) => {
  ...
  console.log("[GeoSpoof Content] Initial settings loaded. Enabled:", spoofingEnabled, "Location:", spoofedLocation);
  updateInjectedScript();
}).catch((error) => {
