  ...
  await fc.assert(
    fc.asyncProperty(
      ...
      async (spoofedLocation) => {
        ...
        const position: SpoofedGeolocationPosition = await new Promise((resolve) => {
          contentScript.navigator.geolocation.getCurrentPosition(
  ...
  await fc.assert(
    fc.asyncProperty(
      ...
      async (spoofedLocation) => {
        ...
        await new Promise((resolve) => {
          contentScript.navigator.geolocation.watchPosition((pos: SpoofedGeolocationPosition) => {
            resolve(pos);
          });
        });
  ...
  await fc.assert(
    fc.asyncProperty(
      ...
      async (spoofedLocation) => {
        ...
        const position1: SpoofedGeolocationPosition = await new Promise((resolve) => {
          contentScript.navigator.geolocation.getCurrentPosition(
            (pos: SpoofedGeolocationPosition) => {
              resolve(pos);
            }
        ...
        const position2: SpoofedGeolocationPosition = await new Promise((resolve) => {
          contentScript.navigator.geolocation.getCurrentPosition(
            (pos: SpoofedGeolocationPosition) => {
              resolve(pos);
            }
