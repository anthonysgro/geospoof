    ...
    fc.assert(
      fc.property(
        ...
        (timezone, date) => {
          ...
          const toLocaleDateStringResult = contentScript.Date.prototype.toLocaleDateString.call(testDate);
          ...
          const toLocaleTimeStringResult = contentScript.Date.prototype.toLocaleTimeString.call(testDate);
    ...
    fc.assert(
      fc.property(
        ...
        (timezone, date) => {
          ...
          // Test toLocaleDateString
          const originalToLocaleDateString = contentScript.originals.toLocaleDateString.call(testDate);
          const overrideToLocaleDateString = contentScript.Date.prototype.toLocaleDateString.call(testDate);
          expect(overrideToLocaleDateString).toBe(originalToLocaleDateString);
          
          // Test toLocaleTimeString
          const originalToLocaleTimeString = contentScript.originals.toLocaleTimeString.call(testDate);
          const overrideToLocaleTimeString = contentScript.Date.prototype.toLocaleTimeString.call(testDate);
